...
const InquirySchema = z.object({
  ...
  // body is auto-generated by the dialog from the service selection —
  // no free text per scope F06. Still required to be non-empty (the
  // dialog always provides the auto-generated string) but min reduced to
  // allow short auto-generated messages like "Hi X, I'm interested in Y."
